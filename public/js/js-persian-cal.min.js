...
"navBack";f=cE("a");f.appendChild(cTN("سال قبل"));f.title="\u0633\u0627\u0644 \u0642\u0628\u0644";f.className="nav";f.href="#";var m=this,n=a[0]-1,p=a[1];f.onclick=function(a){m.changePickerDate(a,n,p);return!1};e.appendChild(f);f=cE("a");f.appendChild(cTN("ماه قبل"));f.title=PERSIAN_MONTH_NAMES[1==a[1]?11:a[1]-2];f.className="nav";f.href="#";var q=this,r=1==a[1]?a[0]-1:a[0],s=1==a[1]?12:a[1]-1;f.onclick=function(a){q.changePickerDate(a,r,s);return!1};e.appendChild(f);g.appendChild(e);e=cE("div");e.className=
"navFwd";f=cE("a");f.appendChild(cTN("سال بعد"));f.title="\u0633\u0627\u0644 \u0628\u0639\u062f";f.className="nav";f.href="#";var t=this,u=a[0]+1,v=a[1];f.onclick=function(a){t.changePickerDate(a,u,v);return!1};e.appendChild(f);f=cE("a");f.appendChild(cTN("ماه بعد"));f.title=PERSIAN_MONTH_NAMES[12==a[1]?0:a[1]];f.className="nav";f.href="#";var w=this,x=12==a[1]?a[0]+1:a[0],y=12==a[1]?1:a[1]+1;f.onclick=function(a){w.changePickerDate(a,x,y);return!1};e.appendChild(f);g.appendChild(e);f=cE("a");f.className=
