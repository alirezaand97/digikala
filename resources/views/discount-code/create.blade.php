...
@section('content')
   ...
   'current'=>['title'=>'افزودن کد تخفیف']
   ])
    @include('includes.warning-message')

    <div class="pannel">
        <h3 class="admin_pages_title">افزودن کد تخفیف جدید</h3>
        {!! Form::open(['url' => 'admin/discount-codes']) !!}
        <div class="row">
            ...
            <div class="col-sm-6 form-group">
               <label>استفاده برای پیشنهادات شگفت انگیز</label>
                <input type="checkbox" name="incredible_offers_allowable" >
