...
@section('content')
    ...
    <div class="pannel">
        ...
        <h3 class="admin_pages_title">
            <p>
                رویداد ورودی به {{$stockroomEvent->getStockroom->name}}
                توسط {{$stockroomEvent->getUser->name?$stockroomEvent->getUser->name:'دیجی کالا'}}
            </p>

        </h3>
        <div class="admin-header">
            <form action="{{url('admin/stockrooms/input/events/'.$stockroomEvent->id)}}">
                <div class="d-flex">
            ...
            <a class="show_factor_btn" href="{{url('admin/stockrooms/input/events/'.$stockroomEvent->id.'/factor')}}">
