...
@section('content')
    ...
    'current'=>['title'=>'ورودی های انبار']
    ])
    <div class="pannel">
        @include('includes.message-alert')
        <h3 class="admin_pages_title">ورودی های انبار </h3>
        <div class="admin-header">
            <form action="{{url('admin/stockrooms/input/events')}}">
                <div class="d-flex">
                ...
                <table class="table table-bordered  table-hover">
                    ...
                    @foreach($events as $event)
                        ...
                        <tr>
                            ...
                            <td class="text-center"><a href="{{url('admin/stockrooms/input/events/'.$event->id)}}"><span data-feather="eye"></span></a></td>
                        </tr>
                    @endforeach
                    @if(count($events)==0)
                        <tr>
