...
@section('content')
   ...
   'current'=>['title'=>'ویرایش محصول']
   ])
    <div class="pannel">
        <h3 class="admin_pages_title">ویرایش</h3>
        ...
        <div class="row">
                ...
                <select class="selectpicker" multiple="multiple" data-live-search="true" name="colors[]" id="colors">
                    @foreach($colors as $color)
                        <option
                            ...
                            value='{{$color->id}}'
                            @if(is_option_selected($selected_colors,'id',$color->id,true)) selected="selected" @endif
                        >
                        </option>
                    @endforeach
                </select>
            ...
            <div class="form-group col-sm-6">
                ...
                {!! Form::select('status',$product_status,$product->status,['class'=>'selectpicker','data-live-search'=>'true']) !!}
            ...
            <div class="col-sm-12 form-group">
                <div class="form-check">
                    ...
                    <input class="form-check-input mr-2" type="checkbox" name="is_gift" @if($product['is_gift_cart']==\App\GiftCart::IS_GIFT_CART) checked="checked" @endif>
                </div>
            </div>
