    ...
    <div class="order_container">
        ...
        <div class="payment_container">
            ...
            <div class="payment_aside">
                <div class="payment_aside_box payment_box">
                    <div class="shopping_check">
                        <ul class="checkout_ul">
                            ...
                            <li class="checkout_item gift_li">
                                <span>کد تخفیف</span>
                                <span class="checkout_price">
                                <span class="price"
                            ...
                            </li> <li class="checkout_item gift_li">
                                <span>کارت هدیه</span>
                                <span class="checkout_price">
                                <span class="price"
                            ...
                            <li>
                                <span class="dg_main_button">ادامه فرایند خرید</span>
                            </li>
                        </ul>
                    </div>
                </div>
