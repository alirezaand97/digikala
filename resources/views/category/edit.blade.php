...
@section('content')
   ...
   'current'=>['title'=>',ویرایش دسته بندی']
   ])

    <div class="pannel">
        <h3 class="admin_pages_title">ویرایش دسته بندی</h3>
        ...
        <div class="row">
            ...
            <div class="form-group col-sm-6" style="margin-bottom: 30px">
                ...
                <input type="file" onchange="load_image(event)" id="cat_image" name="image"  style="display: none">
        ...
        <div class="col-sm-6">
            <button class="btn digi_btn_blue">ویرایش اطلاعات</button>
        </div>
        {!! Form::close() !!}
    </div>
@endsection
