                        ...
                        <div class="new_address">
                            <div v-for="(address,key2) in addressList" v-bind:key="key2" class="address_item"
                                ...
                                <ul class="address_item_ul">
                                    <p class="post_address">
                                        <span>{{address.province.name}}</span>-<span>{{address.city.name}}</span>-<span
            ...
            <div class="shopping_aside">
                <div class="shopping_check">
                    <ul class="checkout_ul">
                        ...
                        <li>
                            <span class="dg_main_button" v-on:click="goToPayment">ادامه فرایند خرید</span>
                        </li>
                    </ul>
                </div>
            </div>
...
<style scoped>
    ...
    .address_list_actions li {
        margin: 0 5px;
        position: relative;
    }

    .address_list_actions li:after {
        content: "";
        position: absolute;
        height: 15px;
        width: 1px;
    ...
    .address_list_actions li:last-child:after {
        content: none;
    }
</style>
