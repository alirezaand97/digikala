    ...
    <div>
        <div class="dg_container">
            <div class="cart_header">
                <h5>سبد خرید</h5>
                <span v-if="cartData.product_data && cartData.product_data.length" class="number_badge">{{cartData.product_data && cartData.product_data.length}}</span>
            </div>
            <div class="cart_container" v-if="cartData.product_data && cartData.product_data.length>0">
                    ...
                    <div class="cart_content_wrapper">
                        <div class="cart_item" v-for="(product,key) in cartData.product_data" v-bind:key="key">
                            ...
                            <div class="cart_p_content">
                                ...
                                <div class="cart_p_detail color" v-if="product.color_name">
                                ...
                                <div class="cart_p_detail cart_item_action">
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div class="mr-3 d-flex align-items-center">
                                            <span class="d-block ml-2">تعداد</span>
                                    ...
                                    <div>
                                        <span class="price">{{nubmer_format(product.price2)}}</span>
                                        <span class="tooman">تومان</span>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="cart_aside">
                    <div class="cart_checkout">
                        <ul class="checkout_ul">
                            ...
                            <li class="checkout_item sum_price">
                                <span>جمع</span>
                                <span class="checkout_price">
                          ...
                          <truck-icon size="1.2x" class="digi_color_red"></truck-icon>
                            ...
                            <li>
                                <a class="dg_main_button" v-bind:href="$siteUrl+'shipping'">ادامه فرایند خرید</a>
                            </li>
